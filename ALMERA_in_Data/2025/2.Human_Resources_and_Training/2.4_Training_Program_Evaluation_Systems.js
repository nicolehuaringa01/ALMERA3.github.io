// ALMERA_in_Data/2025/2.Human_Resources_and_Training/2.4_Training_Program_Evaluation_Systems.js

const csvDataPath4 = "/ALMERA3.github.io/data/2025_ALMERA_Capabilities_Survey.csv"; // Using 'csvDataPath' for clarity in this file

async function initializeStaffTrainingChart() {
    const container = document.getElementById("training-program-chart-container");
    if (!container) {
        console.error("Staff training chart container element #new-staff-training-chart-container not found.");
    ...
    // --- Data Processing ---
    const trainingColumn = '2.4 Does the laboratory have systems to evaluate the training programme?';
