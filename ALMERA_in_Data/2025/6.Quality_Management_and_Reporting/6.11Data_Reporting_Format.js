// ALMERA_in_Data/2025/6.Quality_Management_and_Reporting/6.11Data_Reporting_Format.js

const csvDataPath11 = "/ALMERA3.github.io/data/Observable2025Survey.csv"; // User-provided path
...
function getData_Reporting_FormatCounts(data, Data_Reporting_FormatColumn) {
    ...
    for (const row of data) {
        if (row[Data_Reporting_FormatColumn]) {
            ...
            const Data_Reporting_Formats = row[Data_Reporting_FormatColumn].split(/;|\n|\r/).map(d => d.trim());
