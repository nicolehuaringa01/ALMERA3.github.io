...
const csvDataPath = "https://nicolehuaringa01.github.io/ALMERA3.github.io/data/Observable 2020 Survey + Updated Data (2025).csv"; // CORRECTED PATH
...
async function initializeALMERAMap() {
  ...
  // --- Zoom Functionality ---
  const zoom = d3.zoom()
    .scaleExtent([1, 250]) // Adjust max zoom level
    .on("zoom", (event) => {
