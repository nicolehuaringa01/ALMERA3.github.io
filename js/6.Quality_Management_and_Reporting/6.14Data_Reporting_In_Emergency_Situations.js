// js/6.14Data_Reporting_In_Emergency_Situations

const csvDataPath14 = "/ALMERA3.github.io/data/Observable2020Survey.csv"; // Using 'csvDataPath' for clarity in this file
...
async function initializeData_Reporting_In_Emergency_SituationsChart() {
    ...
    if (!container) {
      console.error("Data_Reporting_In_Emergency_Situations chart container element #Data_Reporting_In_Emergency_Situationss-chart-container not found.");
    ...
    let data;
    try {
        data = await d3.csv(csvDataPath14);
